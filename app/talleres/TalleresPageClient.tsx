...
<section className="relative overflow-hidden">
  ...
  {/* Glow lateral mint */}
  <div className="absolute -top-40 -left-32 hidden h-[600px] w-[600px] md:block
    rounded-full bg-[rgb(var(--brand-mint))/30] blur-3xl" 
  />

  {/* Glow lateral lilac */}
  <div className="absolute -bottom-48 -right-32 hidden h-[650px] w-[650px] md:block
  ...
  <div className="relative mx-auto max-w-6xl px-6 py-16 md:py-24">
    ...
    >
      <h1 className="font-title text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-slate-900 ">
      ...
      <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
        <Link href="#reserva" className="btn-primary btn-cta w-full sm:w-auto rounded-full shadow-lg">
          Solicitar información
        </Link>
        <Link href="#talleres" className="btn-secondary btn-cta w-full sm:w-auto rounded-full">
          Ver talleres
        </Link>
      </div>
    </motion.div>
      ...
      {/* TALLERES */}
      <section id="talleres" className="relative py-16 md:py-20 scroll-mt-24">
      ...
      <section className="relative overflow-hidden py-16 md:py-20">
        ...
        <div className="absolute -top-40 right-[-120px] hidden h-[520px] w-[520px] rounded-full bg-[rgb(var(--brand-mint))/18] blur-3xl md:block" />
        <div className="absolute -bottom-44 left-[-140px] hidden h-[560px] w-[560px] rounded-full bg-[rgb(var(--brand-lilac))/18] blur-3xl md:block" />
            ...
            >
              <Card className="rounded-3xl border border-black/10 bg-white p-8 shadow-sm">
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-3">
                  <Link
                    href="#reserva"
                    className="btn-primary btn-cta w-full sm:flex-1 text-center whitespace-nowrap rounded-full shadow-lg"
                  >
                    Quiero reservar
                  </Link>
                  <Link
                    href="#talleres"
                    className="btn-secondary btn-cta w-full sm:flex-1 text-center whitespace-nowrap rounded-full"
                  >
                    Ver opciones
                  </Link>
                </div>
      ...
      {/* FORM */}
      <section id="reserva" className="relative overflow-hidden py-16 md:py-20 scroll-mt-24">
        <div className="absolute inset-0 bg-gradient-to-br from-[rgb(var(--brand-mint))/10] via-white to-[rgb(var(--brand-lilac))/10]" />
      ...
      <section className="relative overflow-hidden py-20">
        ...
        <div className="relative mx-auto max-w-4xl px-6 text-center text-white">
          ...
          <div className="mt-10">
            <Link
              href="#reserva"
              className="btn-secondary btn-cta rounded-full shadow-lg bg-white text-gray-900 hover:bg-white/90"
            >
              Solicitar información
            </Link>
          </div>
