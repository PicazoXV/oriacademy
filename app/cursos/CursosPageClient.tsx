          ...
          <div className="grid items-center gap-10 md:gap-16 md:grid-cols-2">
            ...
            <div className="space-y-7">
              ...
              <motion.h1
                ...
                className="font-title text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-slate-900 leading-[1.02]"
              >
                Nuestros <br />
              ...
              <motion.p
                ...
                className="text-lg md:text-xl font-semibold text-slate-700 leading-relaxed"
              >
              ...
              >
                <Link href="/horarios" className="btn-primary btn-cta">
                  Consultar horarios
                </Link>
                <Link href="/solicitar-plaza" className="btn-secondary btn-cta">
                  Solicitar plaza
                </Link>
              </motion.div>
...
<section className="border-b border-black/10 bg-white/85 px-6 py-10 backdrop-blur">
  <div className="mx-auto max-w-7xl">
    ...
    >
                ...
                <Card className="group overflow-hidden border border-black/5 bg-white transition-all hover:-translate-y-1 hover:shadow-2xl">
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between pt-6">
                      ...
                      <div className="ml-4 flex h-24 w-24 sm:h-28 sm:w-28 md:h-32 md:w-32 items-center justify-center rounded-3xl bg-white/15 backdrop-blur border border-white/20 shadow-xl overflow-hidden">
                        {course.icon ? (
                          <Image
                            src={`/${course.icon}`}
                            alt={course.subtitle}
      ...
      {/* PATH */}
      <section className="relative overflow-hidden px-6 py-16 md:py-24 bg-[rgb(var(--brand-mint)/0.08)]">
        <div className="pointer-events-none absolute inset-0">
